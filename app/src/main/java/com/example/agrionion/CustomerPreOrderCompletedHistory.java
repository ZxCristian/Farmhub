...
public class CustomerPreOrderCompletedHistory extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pre_order_completed_history, container, false);
        ...
        // Sample data (comment out or remove for testing empty state)
         //preOrderList.add(new CustomerPreOrderModel("478542", "Carrots", "2025-04-05", 8, 20.00));
        // preOrderList.add(new CustomerPreOrderModel("985743", "Onions", "2025-04-08", 15, 45.00));
