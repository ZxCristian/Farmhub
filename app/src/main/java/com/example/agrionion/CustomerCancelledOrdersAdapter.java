...
public class CustomerCancelledOrdersAdapter extends RecyclerView.Adapter<CustomerCancelledOrdersAdapter.OrderViewHolder> {

    private List<CustomerOrder> orderList;

    public CustomerCancelledOrdersAdapter(List<CustomerOrder> orderList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomerCancelledOrdersAdapter.OrderViewHolder holder, int position) {
