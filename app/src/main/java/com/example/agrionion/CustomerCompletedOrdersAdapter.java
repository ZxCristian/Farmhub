...
public class CustomerCompletedOrdersAdapter extends RecyclerView.Adapter<CustomerCompletedOrdersAdapter.OrderViewHolder> {

    private List<CustomerOrder> orderList;

    public CustomerCompletedOrdersAdapter(List<CustomerOrder> orderList) {
